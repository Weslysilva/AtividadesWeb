...
public class Atv1SolProf {
    ...
    String caminho = "/home/wesly/web2/carroProf.tmp";
...
//        }catch(FileNotFoundException ex){};
    ...
    public static ArrayList carregar(ArrayList e, String caminho) throws IOException, ClassNotFoundException{
        ...
        FileReader leia = new FileReader(caminho);
            leia.read();
            
         
         
//          try{
//            FileInputStream Carro = new FileInputStream(caminho+"/carroProf.tmp");
//               try (ObjectInputStream oE = new ObjectInputStream(Carro)) {
...
//           
    ...
    public static void salvar(ArrayList e, String caminho) throws FileNotFoundException, IOException{
        ...
        FileWriter escreva = new FileWriter(caminho, true);
            escreva.write(e.toString() + "\n"); 
